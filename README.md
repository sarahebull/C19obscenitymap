...
## About the project
This interactive map illustrates a small slice of data from _Periodical Advertising, 1822-1870_, a dataset derived from 581 unique periodical advertisements issued by people who sold sexually explicit literature and images in nineteenth-century Britain. The goal of the dataset, and of _Advertising Pornography, 1822-1870_, the larger peer-reviewed project in which it is situated, is to expand scholarly understandings of who sold pornography, what they sold, for how much, when, and where in nineteenth-century Britain. More broadly, it aims to develop better understandings of the trade's development and its changing relationship with other elements of media and culture over time. _Advertising Pornography, 1822-1870_ is available through _Nineteenth-Century Data Collective_ (https://c19datacollective.com/data/advertising-pornography-1822-1870/). You can also download it from <https://github.com/sarahebull/advertising_pornography_1822_to_1870>, or access it via the DOI: 10.34770/9xd0-3p75.
